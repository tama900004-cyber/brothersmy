...
| `/category/all-products` | Wix Stores catalog | Working; 100 products with images and seven new automotive collections | Label `CARS` is misleading | CARS, All Products, View All Offers | Keep Wix route | Low | Change navigation label to Shop; replace placeholder category description |
